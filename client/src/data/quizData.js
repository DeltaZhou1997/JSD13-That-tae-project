...
export const QUIZ_QUESTIONS = [
  {
    ...
    options: [
      ...
      {
        text: "กรกฏาคม - กันยายน",
        subtext: "ฤดูฝน เย็นชุ่มชื่น สมดุล",
        element: "water",
        image: q1_c2,
      },
      {
  ...
  {
    id: 2,
    title: "2. ลักษณะรูปร่างของร่างกายของคุณใกล้เคียงข้อใดที่สุด?",
    options: [
      {
  ...
  {
    id: 3,
    title: "3. เมื่อไม่สบาย คุณมักมีอาการแบบใดบ่อยที่สุด?",
    options: [
      {
  ...
  {
    id: 5,
    title: "5. รสชาติอาหารที่กินแล้วสบายตัวและชอบเป็นพิเศษคือ?",
    options: [
      {
