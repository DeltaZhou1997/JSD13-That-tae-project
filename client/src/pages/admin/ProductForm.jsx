    ...
    if (Array.isArray(product.recipe) && product.recipe.length > 0) {
      setSelectedIngredients(
        product.recipe.map((r) => ({
          ...
          sugar: Number(r.nutrientsPer100g?.sugar) || 0,
          fiber: Number(r.nutrientsPer100g?.fiber) || 0,
          medicinalTaste: r.medicinalTaste || "",
          category: r.category || "",
          categoryTh: r.categoryTh || "",
          elements: r.elements || [],
    ...
    if (existingIndex >= 0) {
      ...
      setSelectedIngredients((prev) => [
        ...prev,
        {
          ...
          sugar: Number(target.nutrientsPer100g?.sugar) || 0,
          fiber: Number(target.nutrientsPer100g?.fiber) || 0,
          medicinalTaste: target.medicinalTaste || "",
          category: target.category || "",
          categoryTh: target.categoryTh || "",
  ...
  const handleSubmit = async (event) => {
    ...
    const payload = {
      ...
      recipe: selectedIngredients.map((s) => ({
        ...
        medicinalTaste: s.medicinalTaste || "",
        category: s.category || "",
        categoryTh: s.categoryTh || "",
        elements: s.elements,
        nutrientsPer100g: {
          calories: s.calories,
          protein: s.protein,
